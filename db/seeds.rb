...
if defined?(User)
  ...
  # "email_address" use kar rahe hain kyunke tumhari table mein yeh column hai
  admin_user = User.find_or_initialize_by(email_address: admin_email)
  
  if admin_user.new_record?
    admin_user.name = "Admin User"
    admin_user.email_address = admin_email
